...
INSERT INTO `Brand` VALUES ('GenPro','B4'),('GoStar','B1'),('Live','B2'),('MagicPlus','B3'),('Vivid','B5');
...
INSERT INTO `Camera` VALUES ('P3','CMOS',50,45,1,3000,30,1);
...
INSERT INTO `Laptop` VALUES ('P4',15.6,1000,'1920X1080',16,4,'Graphics++','GoodProcessor1');
...
INSERT INTO `Laptop_Ports` VALUES ('P4','HDMI'),('P4','LAN'),('P4','USB A'),('P5','USB C');
...
INSERT INTO `Merchant` VALUES ('M1','LESSGOMART','BANK3456','lgm@sql.com','2','MS1','MC1','SQLCITY','1111','23864'),('M2','QUANTAMMART','BANK8623','qm@sql.com','45','MS2','MC2','SQLCITY','1111','83468'),('M3','BREATHEMART','BANK7972','bm@sql.com','44','MS2','MC2','SQLCITY','1111','91274');
...
INSERT INTO `Order` VALUES (1,'amigo1','P2','121212','M3'),(2,'amigo1','P4','334455','M1'),(2,'amigo2','P1','514141','M1'),(1,'amigo3','P4','787005','M3'),(2,'amigo3','P5','787005','M2'),(1,'amigo2','P3','998899','M2');
...
INSERT INTO `Phone` VALUES ('P2',5.6,3400,128,4,'Nextgen V4','720X1280');
...
INSERT INTO `Phone_Cameras` VALUES ('P2',8),('P2',16),('P2',32);
...
INSERT INTO `Processor` VALUES ('GoodProcessor1',4,3.40),('GoodProcessor2',8,3.70);
...
INSERT INTO `Product` VALUES ('P1',1000,'GoStar',23),('P2',2000,'Live',3),('P3',3000,'Vivid',90),('P4',4000,'MagicPlus',40),('P5',5000,'GenPro',100);
...
INSERT INTO `Product_Colours` VALUES ('P2','Black'),('P2','Green'),('P2','Silver'),('P2','White'),('P4','Black'),('P4','White');
...
INSERT INTO `Products_Sold_By` VALUES ('P1','M1'),('P4','M1'),('P3','M2'),('P5','M2'),('P2','M3'),('P4','M3'),('P5','M3');
...
INSERT INTO `Purchase_History` VALUES ('amigo1',1,2000.00,'2015-08-08'),('amigo1',2,4000.00,'2011-08-09'),('amigo2',1,3000.00,'2019-01-01'),('amigo2',2,1000.00,'2018-01-09'),('amigo3',1,4000.00,'2017-08-02'),('amigo3',2,5000.00,'2014-02-04');
...
INSERT INTO `Purchase_History_Products` VALUES ('amigo1','P2',1),('amigo2','P3',1),('amigo3','P4',1),('amigo1','P4',2),('amigo2','P1',2),('amigo3','P5',2);
...
CREATE TABLE `Registered_Customer` (
  ...
  `First_Name` varchar(100) DEFAULT NULL,
  `Last_Name` varchar(100) DEFAULT NULL,
  `Closest_Customer_Care_Office` int(11) DEFAULT NULL,
...
INSERT INTO `Registered_Customer` VALUES ('amigo1','a1@sql.com','898989','Amigo','One',2),('amigo2','a2@sql.com','189724','Amigo','Two',2),('amigo3','a3@sql.com','283568','Amigo','Three',2),('amigo4','a4@sql.com','827461','Amigo','Four',2),('amigo5','a5@sql.com','914373','Amigo','Five',2);
...
INSERT INTO `Registered_Customer_Shipping_Address` VALUES ('amigo1','21','US1','UC1','SQLCITY','1111'),('amigo2','19','US5','UC5','SQLCITY','1111'),('amigo2','33','US1','UC1','SQLCITY','1111'),('amigo3','9','US2','UC2','SQLCITY','1111'),('amigo4','39','US3','UC3','SQLCITY','1111'),('amigo5','98','US4','UC4','SQLCITY','1111');
...
INSERT INTO `Smartwatch` VALUES ('P1',1.54,1,1,'400X400','Blue','White');
...
INSERT INTO `TV` VALUES ('P5',65,1,'4K',80);
...
-- Dump completed on 2020-10-01 10:48:01
